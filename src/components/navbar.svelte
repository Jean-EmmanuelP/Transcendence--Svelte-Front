...
<ModalWrapper bind:isOpen={isModalOpen}>
	...
	{:else if $modalOpen === 'notifications'}
		<div
			class="absolute right-0 h-48 w-[250px] bg-white origin-top-right rounded-md shadow-lg ring-1 ring-black ring-opacity-5 z-50"
		>
			<header class="flex pt-2 pl-4 text-left">
				<div>
